...
class TestWalletAccess:
    ...
    def test_user_cannot_access_other_wallet(self, client, attacker_token):
        """User should not be able to access another user's wallet."""
        response = client.get(
            "/wallets/1",
    ...
    def test_user_cannot_view_other_transactions(self, client, attacker_token):
        """User should not be able to view another user's transactions."""
        response = client.get(
    ...
    def test_user_cannot_transfer_from_other_wallet(self, client, attacker_token):
        """User should not be able to transfer from another user's wallet."""
    ...
    def test_admin_can_view_any_wallet(self, client, admin_token):
        """Admin should be able to view any wallet."""
        response = client.get(
            "/wallets/2",
